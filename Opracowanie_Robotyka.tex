...
\begin{enumerate}
    ...
    Przeliczone do układu postawowego $X_0Y_0Z_0$:
...
\vspace{0.5cm}
\large
$(x,y)$ - współrzedne koła względem układu globalnego;

$\phi$ - orientacja koła względem $X_0$ układu globalnego;

$r$ - promień koła;

$\dot{\theta}$ - prędkośc obrotowa koła;
\normalsize
...
\vspace{0.5cm}
\large
$ A(q) $ - Macirz ograniczeń, zbiór równań BPB, PBW;
\normalsize
