...
\subsubsection{Macierz pseudoinercji}
\Large
...
\begin{kol2}
    ...
    $ g = ( g_x, g_y, g_z, 0 )^T $ - Wektor przbyśpieszenia ziemskiego
...
% todo czy wzorek K = dlugi przechodzi bezposrednio w E_k ?
% Energia kinetyczna dla całego układu
...
\subsubsection{Lagranżjan dla całego układu}
